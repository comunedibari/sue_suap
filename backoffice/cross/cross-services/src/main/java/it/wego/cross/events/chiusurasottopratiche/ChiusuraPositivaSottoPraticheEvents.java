 ...
 */
package it.wego.cross.events.chiusurasottopratiche;
 ...
 */
@Repository("chiusurapositivasottopratiche")
public class ChiusuraPositivaSottoPraticheEvents extends AbstractEvent {
    ...
    public void execute(EventoBean eb) throws Exception {
        ...
        for (Pratica pratica : listPraticheFiglie) {
            ...
            ProcessiEventi ev = processiDao.findProcessiEventiByCodEventoIdProcesso(AnaTipiEvento.EVENTO_CHIUSURA_POSITIVA_DA_PRATICA_PADRE, pratica.getIdProcEnte().getIdProcesso().getIdProcesso());
            if (ev != null) {
