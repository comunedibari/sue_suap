 ...
 * 
 */
@WebServiceClient(name = "Application", targetNamespace = "http://www.simo.org", wsdlLocation = "http://10.101.1.82:8070/?wsdl")
    ...
    extends Service
{
    ...
    private final static QName APPLICATION_QNAME = new QName("http://www.simo.org", "Application");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://10.101.1.81:7789/?wsdl");
    ...
    public Application getApplication() {
        return super.getPort(new QName("http://www.simo.org", "Application"), Application.class);
    }
    ...
    public Application getApplication(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.simo.org", "Application"), Application.class, features);
    }
