...
public class ClassDef  implements java.io.Serializable {
    ...
    private it.asitech.webservice.protocollo.FieldDef[] fieldDef;
    ...
    public ClassDef(
           ...
           it.asitech.webservice.protocollo.FieldDef[] fieldDef,
    ...
    /**
     * Gets the className _value for this ClassDef.
     * 
     * @return className
     */
    ...
    /**
     * Sets the className _value for this ClassDef.
     * 
     * @param className
     */
    ...
    /**
     * Gets the descr _value for this ClassDef.
     * 
     * @return descr
     */
    ...
    /**
     * Sets the descr _value for this ClassDef.
     * 
     * @param descr
     */
    ...
    /**
     * Gets the fieldDef _value for this ClassDef.
     * 
     * @return fieldDef
     */
    public it.asitech.webservice.protocollo.FieldDef[] getFieldDef() {
        if( this.fieldDef==null )
            this.fieldDef = new FieldDef[0];
        return fieldDef;
    }


    /**
     * Sets the fieldDef _value for this ClassDef.
     * 
     * @param fieldDef
     */
    public void setFieldDef(it.asitech.webservice.protocollo.FieldDef[] fieldDef) {
        this.fieldDef = fieldDef;
    }


    /**
     * Gets the flags _value for this ClassDef.
     * 
     * @return flags
     */
    ...
    /**
     * Sets the flags _value for this ClassDef.
     * 
     * @param flags
     */
    ...
    /**
     * Gets the parentClass _value for this ClassDef.
     * 
     * @return parentClass
     */
    ...
    /**
     * Sets the parentClass _value for this ClassDef.
     * 
     * @param parentClass
     */
    ...
    public String toString() {
        ...
        sb.append( "{" )
          ...
          .append( "> className=" ).append( qt(className) )
          .append( " descr=" ).append( qt(descr ) )
          .append( " parentClass=" ).append( qt(parentClass) )
          .append( " flags=[" ).append( flags ).append( "]" )
          .append( " fieldDef=[" );

        int i=0;
        for( FieldDef f : this.getFieldDef() ) {            
            if( i++ > 0 ) {
                sb.append( ", " );
            }
