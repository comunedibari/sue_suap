...
@XmlRootElement(name = "anagrafeTributariaCommercio")
public class AnagrafeTributariaCommercio {

    @XmlElement(required = true)
    protected RecordControllo recordTesta;
    @XmlElement(required = true)
    protected AnagrafeTributariaCommercio.RecordsDettaglio recordsDettaglio;
    @XmlElement(required = true)
     ...
     * @return
     *     possible object is
     *     {@link AnagrafeTributariaCommercio.RecordsDettaglio }
     *     
     */
    public AnagrafeTributariaCommercio.RecordsDettaglio getRecordsDettaglio() {
     ...
     *     
     */
    public void setRecordsDettaglio(AnagrafeTributariaCommercio.RecordsDettaglio value) {
