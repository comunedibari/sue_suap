            ...
            <id_procedimento_suap>
                ...
                <xsl:variable name="codProcedimentoUnico">
                    ...
                    <xsl:variable name="tipoProc">
                        ...
                        <xsl:if test="$massimo = 2 and $minimo != 0">COMUNICAZIONE</xsl:if>
                    ...
                    <xsl:variable name="identificativoProcedimento">
                        <xsl:if test="$tipoProc = 'COMUNICAZIONE'">COMUNICAZDIA</xsl:if>
                        <xsl:if test="$tipoProc = 'ORDINARIO'">ORDINARIO</xsl:if>
                        <xsl:if test="$tipoProc = 'SCIA'">SCIA</xsl:if>
                    </xsl:variable>
