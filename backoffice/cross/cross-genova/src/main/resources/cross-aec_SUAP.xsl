...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
            ...
            <id_procedimento_suap>
                ...
                <xsl:variable name="codProcedimentoUnico">
                    ...
                    <xsl:variable name="tipoProc">
                        <!-- 1 corrisponde a DIA che è equiparato a SCIA -->
                        <xsl:if test="$minimo = $massimo and $minimo = 2">SCIA</xsl:if>
                        <xsl:if test="$minimo = $massimo and $minimo = 1">SCIA</xsl:if>
                        <xsl:if
                            test="not($minimo = $massimo and $minimo = 1) and not($minimo = $massimo and $minimo = 2)"
                            >ORDINARIO</xsl:if>
                    </xsl:variable>
                ...
                <xsl:choose>
                    ...
                    <xsl:otherwise>
                        <xsl:value-of
                            select="/cea:Richiesta/cea:RiepilogoDomanda/cea:Procedimenti/cea:procedimento[1]/cea:codiceProcedimento"
                        />
                    </xsl:otherwise>
                </xsl:choose>
            </id_procedimento_suap>
    ...
    <xsl:template name="anagrafiche">
        ...
        <xsl:variable name="qualitaDi">
            <!-- Imprenditore individuale / Legale Rappresentante di società o ente -->
            <xsl:if
                test="cea:CampoAnagrafica[cea:CampoXmlMod='ANAG_DICHIARANTE_QUALITA_1']/cea:valoreUtente=cea:CampoAnagrafica[cea:CampoXmlMod='ANAG_DICHIARANTE_QUALITA_1']/cea:valore">
                <xsl:value-of
            ...
            <!-- Professionista / altro soggetto munito di procura speciale -->
            <xsl:if
                test="cea:CampoAnagrafica[cea:CampoXmlMod='ANAG_DICHIARANTE_QUALITA_5']/cea:valoreUtente=cea:CampoAnagrafica[cea:CampoXmlMod='ANAG_DICHIARANTE_QUALITA_5']/cea:valore">
                <xsl:value-of
        ...
        <xsl:if test="$qualitaDi = 1">
            <!-- Imprenditore individuale / Legale Rappresentante di società o ent -->
            <anagrafiche>
        ...
        <anagrafica>
            ...
            <cod_cittadinanza>
                <xsl:choose>
                    ...
                    <xsl:when test="$tipo='LegaleRappresentante'">
                        <xsl:value-of
                            select="cea:CampoAnagrafica[cea:CampoXmlMod='ANAG_PGIURIDICA_CIT']/cea:valoreUtente"
                        />
                    </xsl:when>
                </xsl:choose>
            </cod_cittadinanza>
            <des_cittadinanza>
                <xsl:choose>
                    ...
                    <xsl:when test="$tipo='LegaleRappresentante'">
                        <xsl:variable name="cittadinanza">
                            <xsl:value-of
                                select="cea:CampoAnagrafica[cea:CampoXmlMod='ANAG_PGIURIDICA_CITTADINLEG']/cea:valoreUtente"
                            />
                        </xsl:variable>
                        <xsl:for-each
                            select="cea:CampoAnagrafica[(cea:CampoXmlMod='ANAG_PGIURIDICA_CITTADINLEG')]/cea:opzioniCombo/cea:OpzioneCombo">
                            <xsl:if test="cea:Codice = $cittadinanza">
                                <xsl:value-of select="cea:Etichetta"/>
                            </xsl:if>
                        </xsl:for-each>
            ...
            <cod_nazionalita>
                <xsl:choose>
                    ...
                    <xsl:when test="$tipo='LegaleRappresentante'">
                        <xsl:value-of
                            select="cea:CampoAnagrafica[cea:CampoXmlMod='ANAG_PGIURIDICA_NAZ']/cea:valoreUtente"
                        />
                    </xsl:when>
                </xsl:choose>
            </cod_nazionalita>
            <des_nazionalita>
                <xsl:choose>
                    ...
                    <xsl:when test="$tipo='LegaleRappresentante'">
                        ...
                        <xsl:for-each
                            select="cea:CampoAnagrafica[(cea:CampoXmlMod='ANAG_PGIURIDICA_NAZ')]/cea:opzioniCombo/cea:OpzioneCombo">
                            <xsl:if test="cea:Codice = $nazionalita">
                                <xsl:value-of select="cea:Etichetta"/>
                            </xsl:if>
                        </xsl:for-each>
            ...
            <des_tipo_collegio>
                <xsl:choose>
                    <xsl:when test="$tipo='Professionista'">
                        <xsl:value-of
                            select="cea:CampoAnagrafica[cea:CampoXmlMod='ANAG_PROF_COLLEGIO']/cea:valoreUtente"
                        />
                    </xsl:when>
                </xsl:choose>
            </des_tipo_collegio>
            ...
            <data_iscrizione_ri>
                <xsl:choose>
                    ...
                    <xsl:when test="$tipo='ProcuraPersonaGiuridica'">
                        <xsl:value-of
                            select="cea:CampoAnagrafica[cea:CampoXmlMod='ANAG_PGIURIDICA_DATARI']/cea:valoreUtente"
                        />
                    </xsl:when>
                    <xsl:when test="$tipo='ProcuraDittaIndividuale'">
                        <xsl:value-of
            ...
            <flg_attesa_iscrizione_rea>
                <xsl:choose>
                    ...
                    <xsl:when test="$tipo='ProcuraPersonaGiuridica'">
                        <xsl:choose>
                            <xsl:when
                                test="cea:CampoAnagrafica[cea:CampoXmlMod='ANAG_PGIURIDICA_NUMREA']/cea:valoreUtente != ''"
                                >N</xsl:when>
                            <xsl:otherwise>S</xsl:otherwise>
                        </xsl:choose>
                    </xsl:when>
        ...
        <recapito>
            ...
            <des_provincia>
                <xsl:choose>
                    ...
                    <xsl:when test="$tipo='DittaIndividuale'">
                        <xsl:variable name="provinciaSede">
                            <xsl:value-of
                                select="cea:CampoAnagrafica[cea:CampoXmlMod='ANAG_RAPPSOC_PROVSEDE']/cea:valoreUtente"
                            />
                        </xsl:variable>
                        <xsl:for-each
                            select="cea:CampoAnagrafica[(cea:CampoXmlMod='ANAG_RAPPSOC_PROVSEDE')]/cea:opzioniCombo/cea:OpzioneCombo">
                            <xsl:if test="cea:Codice = $provinciaSede">
                                <xsl:value-of select="cea:Etichetta"/>
                            </xsl:if>
                        </xsl:for-each>
                    </xsl:when>
                    ...
                    <xsl:when test="$tipo='ProcuraPersonaGiuridica'">
                        ...
                        <xsl:for-each
                            select="cea:CampoAnagrafica[(cea:CampoXmlMod='ANAG_PGIURIDICA_PROVSEDE')]/cea:opzioniCombo/cea:OpzioneCombo">
                            <xsl:if test="cea:Codice = $provinciaSede">
                                <xsl:value-of select="cea:Etichetta"/>
                            </xsl:if>
                        </xsl:for-each>
            ...
            <indirizzo>
                <xsl:choose>
                    ...
                    <xsl:when test="$tipo='DittaIndividuale'">
                        <xsl:value-of
                            select="cea:CampoAnagrafica[cea:CampoXmlMod='ANAG_RAPPSOC_SL_DENOMINAZIONESTRADALE']/cea:valoreUtente"
                        />
                    </xsl:when>
                    <xsl:when test="$tipo='PersonaGiuridica'">
                        <xsl:value-of
                    ...
                    <xsl:when test="$tipo='ProcuraPersonaGiuridica'">
                        <xsl:value-of
                            select="cea:CampoAnagrafica[cea:CampoXmlMod='ANAG_PGIURIDICA_SL_DENOMINAZIONESTRADALE']/cea:valoreUtente"
                        />
                    </xsl:when>
                    <xsl:when test="$tipo='ProcuraDittaIndividuale'">
                        <xsl:value-of
            ...
            <n_civico>
                <xsl:choose>
                    ...
                    <xsl:when test="$tipo='DittaIndividuale'">
                        <xsl:value-of
                            select="cea:CampoAnagrafica[cea:CampoXmlMod='ANAG_RAPPSOC_SL_NUMEROCIVICO']/cea:valoreUtente"
                        />
                    </xsl:when>
                    <xsl:when test="$tipo='PersonaGiuridica'">
                        <xsl:value-of
                    ...
                    <xsl:when test="$tipo='ProcuraPersonaGiuridica'">
                        <xsl:value-of
                            select="cea:CampoAnagrafica[cea:CampoXmlMod='ANAG_PGIURIDICA_SL_NUMEROCIVICO']/cea:valoreUtente"
                        />
                    </xsl:when>
                    <xsl:when test="$tipo='ProcuraDittaIndividuale'">
                        <xsl:value-of
            ...
            <email>
                <xsl:choose>
                    <xsl:when test="$tipo='Default'">
                        <xsl:value-of
                            select="cea:CampoAnagrafica[cea:CampoXmlMod='ANAG_DICHIARANTE_MAIL']/cea:valoreUtente"
                        />
                    </xsl:when>
                    <xsl:when test="$tipo='Professionista'">
                        <xsl:value-of
                    ...
                    <xsl:when test="$tipo='DittaIndividuale'">
                        <xsl:value-of
                            select="cea:CampoAnagrafica[cea:CampoXmlMod='ANAG_RAPPSOC_MAILSEDE']/cea:valoreUtente"
                        />
                    </xsl:when>
                    <xsl:when test="$tipo='PersonaGiuridica'">
                        <xsl:value-of
                    ...
                    <xsl:when test="$tipo='ProcuraPersonaGiuridica'">
                        <xsl:value-of
                            select="cea:CampoAnagrafica[cea:CampoXmlMod='ANAG_PGIURIDICA_MAILSEDE']/cea:valoreUtente"
                        />
                    </xsl:when>
                    <xsl:when test="$tipo='ProcuraDittaIndividuale'">
                        <xsl:value-of
            ...
            <pec>
                <xsl:choose>
                    ...
                    <xsl:when test="$tipo='DittaIndividuale'">
                        <xsl:value-of
                            select="cea:CampoAnagrafica[cea:CampoXmlMod='ANAG_RAPPSOC_PECSEDE']/cea:valoreUtente"
                        />
                    </xsl:when>
                    <xsl:when test="$tipo='PersonaGiuridica'">
                        <xsl:value-of
                    ...
                    <xsl:when test="$tipo='ProcuraPersonaGiuridica'">
                        <xsl:value-of
                            select="cea:CampoAnagrafica[cea:CampoXmlMod='ANAG_PGIURIDICA_PECSEDE']/cea:valoreUtente"
                        />
                    </xsl:when>
                    <xsl:when test="$tipo='ProcuraDittaIndividuale'">
                        <xsl:value-of
