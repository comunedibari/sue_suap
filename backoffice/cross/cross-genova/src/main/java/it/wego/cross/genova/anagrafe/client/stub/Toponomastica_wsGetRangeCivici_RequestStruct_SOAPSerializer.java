...
public class Toponomastica_wsGetRangeCivici_RequestStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public Toponomastica_wsGetRangeCivici_RequestStruct_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        Toponomastica_wsGetRangeCivici_RequestStruct instance = new Toponomastica_wsGetRangeCivici_RequestStruct();
        Toponomastica_wsGetRangeCivici_RequestStruct_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_sXmlFile_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new Toponomastica_wsGetRangeCivici_RequestStruct_SOAPBuilder();
                    }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        Toponomastica_wsGetRangeCivici_RequestStruct instance = (Toponomastica_wsGetRangeCivici_RequestStruct) obj;
