...
public class OrdinamentoRubricaTest {

    static final private String TESTFAMILY = "OrdinamentoRubrica";
    static final private String TEST_01 = "Ordinamento_Rubrica"; //5.1
    static final private String TEST_04 = "Ricerca_Rubrica_03"; //5.4
    static final private String TEST_08 = "Selezione_anagrafica_da_modificare"; //5.8
    ...
    @Test
    public void Ricerca_Rubrica_03() throws Exception {
        boolean success = true;
        ...
        SeleniumUtilities.wait_for_ajax_loading(driver, tmess);
        List<String> denomResult = tableResult.get(2);
    ...
    public void Selezione_anagrafica_da_modificare() throws Exception {
        ...
        if (unLabel.equals("Nome")) {
            ...
            if (!fisResult.get(0).equals(codDetail)) {
                ...
                tmess.risultati("I risultati di ricerca e anagrafica selezionata coincidono.");
            }
        } else {
    ...
    public void Modifica_anagrafica_persona_fisica_1() throws Exception {
        ...
        tmess.azione("Il dettaglio dell'anagrafica scelta presenta i seguenti dati, nome: " + bloccoLettura.get(0) + " cognome: " + bloccoLettura.get(1) + " data: " + bloccoLettura.get(3) + " cittadinanza: " + bloccoLettura.get(5)
                + " comune: " + bloccoLettura.get(7));
        ...
        SeleniumUtilities.safeFind(driver, By.id("partitaIvaProfessionista"), tmess).sendKeys("P00I00V00A");
        SeleniumUtilities.safeFind(driver, By.id("desTipoCollegio"), tmess).sendKeys("Dati_collegio");
        SeleniumUtilities.safeFind(driver, By.id("numeroIscrizione"), tmess).sendKeys("001");
        SeleniumUtilities.safeFind(driver, By.id("dataIscrizione"), tmess).sendKeys(("02/01/00"));
        SeleniumUtilities.safeFind(driver, By.id("desProvinciaIscrizione"), tmess).sendKeys("Dati_provincia");
        SeleniumUtilities.safeFind(driver, By.id("nIscrizioneRea"), tmess).sendKeys("101");
        SeleniumUtilities.safeFind(driver, By.id("dataIscrizioneRea"), tmess).sendKeys("03/01/00");
        ...
        tmess.azione("modifico i dati ottenendo la seguente configurazione, nome: " + bloccoLettura2.get(0)+", cognome: "+bloccoLettura2.get(1)+", data: "+bloccoLettura2.get(3)+", cittadinanza: "+bloccoLettura2.get(5)
                +", comune: "+bloccoLettura2.get(7)+", localita' nascita: "+bloccoLettura2.get(8)+", partita IVA: "+bloccoLettura2.get(9)+", tipo collegio: "+bloccoLettura2.get(11)+", numero iscrizione: "+bloccoLettura2.get(12)
        ...
        CleanDetail();
        SeleniumUtilities.safeFind(driver, By.id("nome"), tmess).sendKeys(bloccoLettura.get(0));
        SeleniumUtilities.safeFind(driver, By.id("cognome"), tmess).sendKeys(bloccoLettura.get(1));
        SeleniumUtilities.safeFind(driver, By.id("dataNascita"), tmess).sendKeys(bloccoLettura.get(3));
        SeleniumUtilities.safeFind(driver, By.id("desCittadinanza"), tmess).sendKeys(bloccoLettura.get(5));
        SeleniumUtilities.safeClick(driver, By.linkText(bloccoLettura.get(5)), tmess);
        SeleniumUtilities.safeFind(driver, By.id("desComuneNascita"), tmess).sendKeys(bloccoLettura.get(7));
        SeleniumUtilities.safeClick(driver, By.partialLinkText(bloccoLettura.get(7)), tmess);
        SeleniumUtilities.safeFind(driver, By.id("localitaNascita"), tmess).clear();
        SeleniumUtilities.safeFind(driver, By.id("partitaIvaProfessionista"), tmess).clear();
        SeleniumUtilities.safeFind(driver, By.id("desTipoCollegio"), tmess).clear();
        SeleniumUtilities.safeFind(driver, By.id("numeroIscrizione"), tmess).clear();
        SeleniumUtilities.safeFind(driver, By.id("dataIscrizione"), tmess).clear();
        SeleniumUtilities.safeFind(driver, By.id("desProvinciaIscrizione"), tmess).clear();
    ...
    public void Modifica_anagrafica_persona_fisisca_2() throws Exception {
        ...
        tmess.azione("Seleziono un utente persona fisica casualmente.");
        ...
        tmess.azione("Modifico i dati anagrafici.");
        SeleniumUtilities.safeClick(driver, By.xpath("(//button[@type='button'])[4]"), tmess);
        SeleniumUtilities.wait_for_ajax_loading(driver, tmess);

        tmess.Errori("Il popUp seguente non è cliccabile da Selenium, pertanto nessuna modifica è apportabile.");
    ...
    public void Modifica_anagrafica_persona_giuridica_1() throws Exception {
        ...
        if(controlloLettura.equals(bloccoLettura)){
    ...
    private void OpenSearchPanel() {
        SeleniumUtilities.safeClick(driver, By.cssSelector(WebElMap.AP_RUBR_PANNELLO_SEARCH), tmess);
    }
