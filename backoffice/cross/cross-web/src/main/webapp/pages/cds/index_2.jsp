...
<script type="text/javascript">
    function handleGridResize(grid_selector){
    ...
    jQuery(function($) {
        ...
        handleGridResize(grid_selector);

        jQuery(grid_selector).jqGrid({
            url: '${path}/console/index/ajax.htm',
            datatype: "json",
            height: '100%',
            sortname: 'data',
            sortorder: "desc",
            colModel: [
                ...
                },
                {
                    ...
                    formatter:function(cellvalue, options, rowObject) {
                        return rowObject["trace"].substring(0, rowObject["trace"].indexOf('\n'));
                    }
                },
                {   
                    name: 'myac', 
            ...
            viewrecords: false,
            emptyrecords: 'Non sono presenti record',
            rowNum: 10,
            rowList: [10, 20, 30],
