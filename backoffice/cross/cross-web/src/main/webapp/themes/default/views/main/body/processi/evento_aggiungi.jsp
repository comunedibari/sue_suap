...
<div>
    <h2 style="text-align: center"><spring:message code="evento.aggiungi.title"/></h2>
            ...
            <div class="sidebar_auto">
                <div class="page-control" data-role="page-control">
                        ...
                        <div class="frame" id="frame4">
                            ...
                            <div class="inlineLabels">
                                <div class="table-add-link">
                                    <a class="button" onclick="aggiungiScadenza()">
                                        <spring:message code="evento.scadenza.add"/>
                                        <img src="<%=path%>/themes/default/images/icons/add.png" alt="<spring:message code="evento.scadenza.add"/>" title="<spring:message code="evento.scadenza.add"/>">
                                    </a>
                                </div>
                                ...
                                <script>
                                    ...
                                    function aggiungiScadenza() {
                                        ...
                                        var newsection = '<div class="scadenza" id="scadenza_' + counter + '">';
                                        if (counter > 0) {
                                            newsection += '<hr />';
                                        }
                                        ...
                                        newsection += '<div class="table-add-link"><a class="button" onclick="rimuoviScadenza(\'#scadenza_' + counter + '\')">' + labelRimuoviScadenza;
                                        newsection += '<img src="<%=path%>/themes/default/images/icons/delete.png" alt="' + labelRimuoviScadenza + '" title="' + labelRimuoviScadenza + '" </a></div>';
                                        newsection += '</div>';
                                ...
                                <fieldset id="scadenzeFieldset" class="fieldsetComunicazione fieldsetEvento" style="display: none">
                                    <legend><spring:message code="evento.scadenza.title"/></legend>
                                </fieldset>
                            </div>
                        </div>
                        <c:if test="${isGestioneAnagraficheEventi}">
                    ...
                    <div class="buttonHolder">
                        ...
                        <button type="submit" class="primaryAction" name="submit" value="<spring:message code="processo.button.salva"/>"><spring:message code="processo.button.salva"/></button>
                    </div>
                </div>
                <div class="clear"></div>    
            </div>
