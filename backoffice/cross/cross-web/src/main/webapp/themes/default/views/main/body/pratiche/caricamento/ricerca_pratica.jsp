                        ...
                        <div class="ctrlHolder">
                                    ...
                                    <div class="ricerca_div_forms">    
                                        <div class="inlineLabels">
                                            ...
                                            <div class="ctrlHolder">
                                                <label for="search_all"><spring:message code="ricerca.visualizzatutte"/><input id="search_all" name="search_all" type="checkbox" class="choice checkbox_width" value="S"></label>
