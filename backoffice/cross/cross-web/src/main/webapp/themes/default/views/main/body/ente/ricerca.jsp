                ...
                <div class="ricerca_div_forms">  
                    <div class="inlineLabels">
                        <div class="ctrlHolder">
                            <label for="enteDescrizione"><spring:message code="ente.descrizione"/></label>
                            <input id="enteDescrizione" name="descrizione" size="35" maxlength="250" type="text" class="textInput" value="${filtroRicerca.denominazione}"/>
                        </div>
                        <div class="ctrlHolder">
                            <label for="codiceFiscale"><spring:message code="ente.codiceFiscale"/></label>
                        ...
                        <div class="ctrlHolder">
                            <label for="partitaIva"><spring:message code="ente.partitaIva" /></label>
                            <input id="partitaIva" name="partitaIva" size="35" maxlength="250" type="text" class="textInput" value="${filtroRicerca.partitaIva}"/>
                        </div>
                    </div>
                </div>
