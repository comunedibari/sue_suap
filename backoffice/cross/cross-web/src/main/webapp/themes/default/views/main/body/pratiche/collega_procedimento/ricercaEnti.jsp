    ...
    <div>
        <form id="form_ricerca" class="uniForm inlineLabels" method="post">
            ...
            <div class="inlineLabels">
                ...
                <input id="search_idProcedimento" name="search_idProcedimento" type="hidden"  value="${ricerca.idProcedimento}">
                <div class="ctrlHolder" id="search_desEnte_container" >
                    ...
                    <input id="search_desEnte" name="search_denominazione" size="35" maxlength="255" type="text" class="textInput" value="${ricerca.descrizione}">
                    <p class="formHint"></p>
                </div>
            </div>
