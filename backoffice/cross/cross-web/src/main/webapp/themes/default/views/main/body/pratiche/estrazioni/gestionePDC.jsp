    ...
    $(document).ready(function() {
        ...
        $("#list").jqGrid
                ({
                    url: url,
                    datatype: "json",
                    colModel:${estrazioniPdcColumnModel},
                    /*
...
<div id="apertura_pratiche">
    ...
    <div class="buttonHolder" style="background-color: #E6E6E6;text-align: right">
    	<a title=<spring:message code="esporta.excel"/> href="${path}/excel/pdc.htm"><spring:message code="esporta.ods"/></a>
    </div>
    <div class="buttonHolder" style="background-color: #E6E6E6;text-align: right">
    	<a title=<spring:message code="esporta.excel"/> href="${path}/excel/pdc.htm?xls=1"><spring:message code="esporta.excel"/></a>
    </div>
