...
<div id="ricerca">
    ...
    <div>
        <form id="form_ricerca" action="<%= path%>/excel/cilaToDo.htm" class="uniForm inlineLabels" method="post">
            ...
            <div style="width:1080px;">    
                ...
                <div class="ricerca_div_forms">    
                 ...
                 <div class="buttonHolder" style="background-color: #E6E6E6;text-align: center"> 
                     <button id="ricerca_button" type="submit" class="primaryAction fondo_destra" style="background-color: #0067A9" onclick = "submitXls(0)">Esporta ods </button>				
                     <button id="ricerca_button" type="submit" class="primaryAction fondo_destra" style="background-color: #0067A9" onclick = "submitXls(1)">Esporta excel
                     	<input id="xls" name="xls" type="hidden" />
                     </button>	
                 </div>
<!-- 				<div class="buttonHolder" style="background-color: #E6E6E6; text-align: right"> -->
<%-- 					<a title=<spring:message code="esporta.excel"/>	href="${path}/excel/cilaToDo.htm">Esporta CILA TODO</a> --%>
<!-- 				</div> -->
			</div>
        </form>
    </div>
...
<script type="text/javascript">
        ...
        function submitXls(download) {
        	document.getElementById('xls').value = download;
