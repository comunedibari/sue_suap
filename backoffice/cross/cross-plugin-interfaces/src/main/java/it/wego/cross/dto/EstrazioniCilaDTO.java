...
public class EstrazioniCilaDTO extends AbstractDTO implements Serializable{
	...
	public Date getData_sospensione() {
		return data_sospensione;
	}
	public void setData_sospensione(Date data_sospensione) {
