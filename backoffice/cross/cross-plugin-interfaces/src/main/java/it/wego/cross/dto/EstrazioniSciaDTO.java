...
public class EstrazioniSciaDTO extends AbstractDTO implements Serializable{
	...
	private Date data_divieto;
	private Date data_Integrazione;
	private Date data_parere_favorevole;
	...
	public Date getData_divieto() {
		return data_divieto;
	}
	public void setData_divieto(Date data_divieto) {
		this.data_divieto = data_divieto;
	}
	...
	public Date getData_parere_favorevole() {
		return data_parere_favorevole;
	}
	public void setData_parere_favorevole(Date data_parere_favorevole) {
		this.data_parere_favorevole = data_parere_favorevole;
	}
