...
public class Output {
    ...
    protected List<Output.CampoPrecompilazioneBean> campoPrecompilazioneBean;
     ...
     * {@link Output.CampoPrecompilazioneBean }
     * 
     * 
     */
    public List<Output.CampoPrecompilazioneBean> getCampoPrecompilazioneBean() {
        if (campoPrecompilazioneBean == null) {
            campoPrecompilazioneBean = new ArrayList<Output.CampoPrecompilazioneBean>();
        }
