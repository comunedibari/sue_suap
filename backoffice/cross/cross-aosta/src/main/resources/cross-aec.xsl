        ...
        <pratica>
            ...
            <id_procedimento_suap>
                ...
                <xsl:variable name="tipoProc">
                    <xsl:if test="$minimo = 0">ORDINARIO</xsl:if>
                    <xsl:if test="not($minimo = 0)">SCIA</xsl:if>
                </xsl:variable>
...
<!--                <xsl:value-of
    ...
    <xsl:template name="anagrafiche">
        ...
        <!--<quallo><xsl:value-of select="$qualitaDi"/></quallo>
        <proco><xsl:value-of select="$procurato"/></proco>-->
        ...
        <anagrafica>
            ...
            <tipo_anagrafica>
                <xsl:choose>
                    ...
                    <xsl:when test="$tipo='ImpresaEsecutriceHref'">
                        <xsl:choose>
                            <xsl:when test="//cea:DichiarazioneDinamica[cea:href='h00257']//cea:campoHref[cea:nome='d011']/cea:valoreUtente = 'I'">F</xsl:when>
            ...
            <variante_anagrafica>
                <xsl:choose>
                    ...
                    <xsl:when test="$tipo='ImpresaEsecutriceHref'">
                        <xsl:choose>
                            <xsl:when test="//cea:DichiarazioneDinamica[cea:href='h00257']//cea:campoHref[cea:nome='d011']/cea:valoreUtente = 'I'">I</xsl:when>
                        </xsl:choose>
                    </xsl:when>
                </xsl:choose>
            </variante_anagrafica>
            ...
            <des_provincia_nascita>
                <xsl:choose>
                    ...
                    <xsl:when test="$tipo='Privato'">
                        <xsl:value-of
                            select="cea:CampoAnagrafica[cea:CampoXmlMod='ANAG_RAPPPRIV_PROVNASCITARAP']/cea:valoreUtente"
                        />
                    </xsl:when>
                    <xsl:when test="$tipo='Professionista'">
                        <xsl:value-of
                    ...
                    <xsl:when test="$tipo='ProcuraPersonaFisica'">
                        <xsl:value-of
                            select="cea:CampoAnagrafica[cea:CampoXmlMod='ANAG_PFISICA_PROVNASCITA']/cea:valoreUtente"
                        />
                    </xsl:when>
                    <xsl:when test="$tipo='DirettoreLavoriHref'">
                        <xsl:value-of
