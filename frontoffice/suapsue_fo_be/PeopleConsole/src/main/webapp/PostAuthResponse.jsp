...
<html>
  <head>
    ...
    <body onload="javascript:document.forms[0].submit()"> 
        <form method="post" action="${authResponse.formAction}">
            <input type="hidden" name="authResponse" value="${authResponse.response}" />
            <input type="hidden" name="expiresOn" value="${authResponse.expirationDateTime}" />
