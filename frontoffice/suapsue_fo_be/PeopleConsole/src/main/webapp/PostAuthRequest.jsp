...
<html>
  <head>
    ...
    <body onload="javascript:document.forms[0].submit()">
        <form method="post" action="${authRequest.formAction}">
            <input type="hidden" name="TARGET" value="${authRequest.target}">
            <input type="hidden" name="AuthRequest" value="${authRequest.request}">
