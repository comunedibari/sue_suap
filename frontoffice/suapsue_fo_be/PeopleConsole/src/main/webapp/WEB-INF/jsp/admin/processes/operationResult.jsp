...
<html>
	...
	<body>
		<form:form>
			...
			<c:if test="${isArchive}">
				<c:choose>
					<c:when test="${!archiveResult.error}">
				...
				<div class="${divClass}">
					Eliminate ${archiveResult.deletedRows} pratiche.
					${archiveResult.errorMessage}
					File di backup: ${archiveResult.backupFilePath}<br/><br/>
			...
			<c:if test="${isDelete}">
				...
				<div class="${divClass}">
					Eliminate ${archiveResult.deletedRows} pratiche.
					${archiveResult.errorMessage}<br/><br/>
				</div>
			</c:if>

			<div class="buttonsbar">
				<input type="submit" id="finish" name="confirmAction" value="Ok" class="button" />
			</div>
		</form:form>
	</body>
</html>
