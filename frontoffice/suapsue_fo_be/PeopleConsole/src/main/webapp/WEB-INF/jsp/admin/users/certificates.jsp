...
<html>
	<head>
		<title><spring:message code="admin.certificates.listAndAdd.title" /></title>
	</head>
	<body>
		<form:form modelAttribute="certificatesAccountManager">
			<h1>Accounts senza certificato</h1>

			<pcform:listHolderTable pagedListHolderId="accountsWithoutCertificatesList" 
				pagedListHoldersCache="${certificatesAccountManager.pagedListHolders}" 
			...
			<h1>Accounts con certificato</h1>
			<%@ include file="/WEB-INF/jsp/includes/filters.jsp"%>
			<pcform:listHolderTable pagedListHolderId="certificateAccountsList" 
				pagedListHoldersCache="${certificatesAccountManager.pagedListHolders}" 
				componentClass="pagedListHolderTable" 
				pagerClass="pagedListHolderPager" 
				pagerPagesTitleClass="pagedListHolderPagerTitleClass" 
