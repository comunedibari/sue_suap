...
public interface ICryptoUtils {
	...
	public String getDecryptedData(String cryptoObjectString) throws IOException, GeneralSecurityException, ClassNotFoundException, SignCorruptionException, CryptoUtilsException;
