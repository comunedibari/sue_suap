 ...
 * @created 15/gen/2011 23.32.34
 *
 */
public class EditableRowColumnMapRowMapper extends AbstractLogger implements RowMapper<EditableRow> {

	public EditableRow mapRow(ResultSet rs, int rowNum) throws SQLException {
...
//			String key = getColumnKey(JdbcUtils.lookupColumnName(rsmd, i));
			...
			if (mapOfColValues.containsKey(key)) {
				key = rsmd.getTableName(i) + "." + key;
			}
			mapOfColValues.put(key, obj);
		}
		return new EditableRow(mapOfColValues);
	}
