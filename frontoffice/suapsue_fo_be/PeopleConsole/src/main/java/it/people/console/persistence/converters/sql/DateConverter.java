...
/**
 * <p>Title: Stazione Editoriale Espin</p>
 * <p>Description: Stazione Editoriale Espin</p>
    ...
    public Object javaToSql(Object source) throws ConversionException {
        if (source instanceof java.util.Date) {
            ...
            if (source == null)
                ...
                throw new ConversionException("Unable to convert object to a java.sql.Date");
        }
    }
    public Object sqlToJava(Object source) throws ConversionException {
        if (source instanceof java.sql.Timestamp) {
            ...
            if (source == null)
                ...
                throw new ConversionException("Unable to convert object to a java.util.Date");
        }
    }
}
