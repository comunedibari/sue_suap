    ...
    public Object javaToSql(Object source) throws ConversionException {
        if (source instanceof Boolean) {
            ...
            if (source == null)
                ...
                throw new ConversionException("Unable to convert object to a java.math.BigDecimal");
        }
    }
    public Object sqlToJava(Object source) throws ConversionException {
        if (source instanceof Number) {
            ...
            if (source == null)
                ...
                throw new ConversionException("Unable to convert object to a java.lang.Boolean");
        }
    }
}
