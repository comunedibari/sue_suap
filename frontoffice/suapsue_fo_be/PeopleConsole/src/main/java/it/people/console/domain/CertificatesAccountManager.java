 ...
 *
 */
public class CertificatesAccountManager extends AbstractBaseBean implements Clearable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 5419677189914602772L;

	public CertificatesAccountManager() {
