 ...
 *
 */
public class RowMapperResultSetExtractorEditableRowWithMetaData extends AbstractLogger implements ResultSetExtractor<RowMapperResultSetEditableRowWithMetaData> {

	private final RowMapper<EditableRow> rowMapper;

	private final int rowsExpected;


	/**
	 * Create a new RowMapperResultSetExtractorEditableRowWithMetaData.
	 * @param rowMapper the RowMapper which creates an object for each row
	 */
	public RowMapperResultSetExtractorEditableRowWithMetaData(RowMapper<EditableRow> rowMapper) {
		this(rowMapper, 0);
	}
	 ...
	 */
	public RowMapperResultSetExtractorEditableRowWithMetaData(RowMapper<EditableRow> rowMapper, int rowsExpected) {
	...
	public RowMapperResultSetEditableRowWithMetaData extractData(ResultSet rs) throws SQLException {
		...
		List<EditableRow> dataBuffer = (this.rowsExpected > 0 ? new ArrayList<EditableRow>(this.rowsExpected) : new ArrayList<EditableRow>());
		int rowNum = 0;
		while (rs.next()) {
