 ...
 *
 */
public class AvailableServicesListOrderer implements Comparator<AvailableService>, Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7520080056505923306L;
	...
	public int compare(AvailableService o1, AvailableService o2) {
		...
		int result = o1.getServiceName().compareToIgnoreCase(o2.getServiceName());
