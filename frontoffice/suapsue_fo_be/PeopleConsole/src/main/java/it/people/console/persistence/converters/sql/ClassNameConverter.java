...
public class ClassNameConverter implements FieldConversion  {
    private Category cat = Category.getInstance(ClassNameConverter.class.getName());
    ...
    public Object javaToSql(Object clazz) throws ConversionException {
        ...
        if (clazz instanceof Class) {
            ...
            if (clazz == null)
                ...
                throw new ConversionException("Unable to convert object to a Class Object");
            }
        }
    }
        ...
        if (p_obj_className instanceof String) {
            ...
            if (p_obj_className == null)
                ...
                throw new ConversionException(
                        "Unable to convert object Class");
            }
        }
        return null;
    }
