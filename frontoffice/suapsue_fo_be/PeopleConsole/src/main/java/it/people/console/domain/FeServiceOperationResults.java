 ...
 *
 */
public class FeServiceOperationResults implements Serializable {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 4562569047357394239L;
	...
	public FeServiceOperationResults() {
	}
	
	public FeServiceOperationResults(String servicePackage, Vector<ObjectError> errors) {
