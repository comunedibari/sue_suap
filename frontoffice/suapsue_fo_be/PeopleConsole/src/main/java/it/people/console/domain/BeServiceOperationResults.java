 ...
 *
 */
public class BeServiceOperationResults implements Serializable {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 6329507742816059084L;
	...
	public BeServiceOperationResults() {
	}
	
	public BeServiceOperationResults(String servicePackage, Vector<ObjectError> errors) {
