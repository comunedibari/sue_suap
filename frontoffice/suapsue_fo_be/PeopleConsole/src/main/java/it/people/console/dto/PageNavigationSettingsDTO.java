 ...
 *
 */
public class PageNavigationSettingsDTO implements Clearable {

	private String resultsForPage;
	
	public PageNavigationSettingsDTO() {
	 ...
	 */
	public final String getResultsForPage() {
	 ...
	 */
	public final void setResultsForPage(String resultsForPage) {
