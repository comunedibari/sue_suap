 ...
 * @created 19/giu/2011 23.05.12
 *
 */
public class TestCertBuilder {

	static char[]   passwd = { 'a' };

	static final ASN1ObjectIdentifier commune = new ASN1ObjectIdentifier("1.2.840.113549.300.600");
	
	static final ASN1ObjectIdentifier commune_id = commune.branch("900");
	...
	throws Exception
	{
		...
		Certificate[] chain1 = new Certificate[1];
		...
		//
		store.setKeyEntry("Eric's Key", privKey, null, chain1);

		FileOutputStream fOut = new FileOutputStream("c:/id1.p12");
