...
<%--  
    <body onload="javascript:document.forms[0].submit()"> 
        <form method="post" action="<c:out value='${authResponse.formAction}' />">
            <input type="hidden" name="TARGET" value="<c:out value='${authResponse.target}' />">
            <input type="hidden" name="SAMLResponse" value="<c:out value='${authResponse.response}' />">
            <input type="hidden" name="authResponseStatus" value="<c:out value='${authResponse.responseStatus}' />">
...
--%>
    <body>
        <form method="post" action="<c:out value='${authResponse.formAction}' />">
            ...
            TARGET:<br>
            <textarea rows=10 cols="80" name="TARGET"><c:out value='${authResponse.target}' /></textarea><br>
            SAML Response (Base64):<br>
            <textarea rows=10 cols="80" name="SAMLResponse"><c:out value='${authResponse.response}' /></textarea><br>
            Authentication Response Status:<br>
            <input type="text" size=50 name="authResponseStatus" value="<c:out value='${authResponse.responseStatus}' />"><br>
            ...
            %>
            SAML Response (Base 64 decoded):<br>
