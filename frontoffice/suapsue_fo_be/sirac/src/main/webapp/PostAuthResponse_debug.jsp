...
<%@ page import="it.people.sirac.crypto.SymmetricCryptoManager" %>
<%-- JSTL --%>
...
String keyFile = application.getInitParameter("encryptAuthResponseKeyFile");
String keyFilePath = application.getRealPath(keyFile);
String passphrase = application.getInitParameter("encryptAuthResponseKeyFilePassPhrase");
