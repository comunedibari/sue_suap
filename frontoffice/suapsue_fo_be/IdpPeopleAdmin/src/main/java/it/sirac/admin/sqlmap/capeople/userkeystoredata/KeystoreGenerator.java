...
public class KeystoreGenerator
{
  ...
  public static KeyStore createP12(String userID, KeyStore caKeyStore, String caKeyStoreAlias, String caKeyStorePassword, String keystorePassword, String domicioElettronico, String nome, String cognome)
  {
    try
    {
      ...
      certificateGenerator.addExtension(X509Extensions.CRLDistributionPoints.getId(), false, new DERSequence(crlDistributionPoint));
      ...
      SubjectPublicKeyInfo apki = new SubjectPublicKeyInfo((ASN1Sequence)new ASN1InputStream(new ByteArrayInputStream(pubKeyCA.getEncoded())).readObject());
