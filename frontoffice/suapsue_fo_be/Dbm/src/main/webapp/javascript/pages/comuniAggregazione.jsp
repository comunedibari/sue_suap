...
var table_name = 'comuni_aggregazione';
var sort_field = 'a.tip_aggregazione';
...
windowLink:"<%=basePath%>protected/TipiAggregazione.jsp?set_id=<%=set_id%>",
...
triggerAggregazioni.setDisableButton1();
triggerAggregazioni.setDisableButton2();
triggerAggregazioni.setEnableButton3();
