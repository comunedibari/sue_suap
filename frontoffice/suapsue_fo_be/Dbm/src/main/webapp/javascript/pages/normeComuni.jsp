...
%>
    Ext.onReady(function(){
        ...
        var table_name = 'norme_comuni';
        var sort_field = 'a.cod_rif';
        ...
        var itemsForm = [triggerNormative,{
                id: 'tit_rif',
        ...
        var searchSelectionModel = new Ext.grid.RowSelectionModel({
            ...
            listeners: {
                rowselect: function(sm, row, rec) {
                    ...
                    triggerNormative.setDisableButton1();
                    triggerNormative.setDisableButton2();
                    triggerNormative.setEnableButton3();
