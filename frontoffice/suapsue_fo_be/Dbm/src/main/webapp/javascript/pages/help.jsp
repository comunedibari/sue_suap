...
%>
    Ext.onReady(function(){
        ...
        var dyn_fields_protection = ['id_help'];
        ...
        var colModel = new Ext.grid.ColumnModel([
            {
                id:'grid_id_help',
                header: "<%=testiPortale.get(nomePagina+"_header_grid_id_help")%>",
                width: 30,
                sortable: true,
                dataIndex: 'id_help'
            },
            {
                id:'grid_des_help',
                header: "<%=testiPortale.get(nomePagina+"_header_grid_des_help")%>",
                renderer: renderTpl,
                width: 100,
                sortable: true,
                dataIndex: 'des_help'
        ...
        var txtFld = new Ext.form.TextField({
            id: 'id_help',
            fieldLabel: "<%=testiPortale.get(nomePagina+"_field_form_id_help")%>",
            name: 'id_help',
            allowBlank: false,
        ...
        var	itemsForm = [txtFld,{
                id: 'des_help',
                fieldLabel: "<%=testiPortale.get(nomePagina+"_field_form_des_help")%>",
                name: 'des_help',
                maxLength:255,
                allowBlank: false,
                labelStyle: 'font-weight:bold;'
                ...
                id: 'testo_help',
                fieldLabel: "<%=testiPortale.get(nomePagina+"_field_form_testo_help")%>",
                name: 'testo_help',
                xtype:'textarea',
                height: 100,
                allowBlank: false,
