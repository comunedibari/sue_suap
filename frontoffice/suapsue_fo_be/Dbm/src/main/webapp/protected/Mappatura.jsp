...
<script type="text/javascript" src="<%=basePath%>javascript/pages/mappatura.jsp?nomePagina=<%=nomePagina%>&set_id=<%=set_id%>"></script>
<title>Mappatura</title>
