...
<%
            String nomePagina = "TipiAggregazione";
...
<script type="text/javascript" src="<%=basePath%>javascript/pages/tipiAggregazione.jsp?nomePagina=<%=nomePagina%>&set_id=<%=set_id%>"></script>
<title>Tipi Aggregazione</title>
</head>
<body>
    <div id="wrapper">
