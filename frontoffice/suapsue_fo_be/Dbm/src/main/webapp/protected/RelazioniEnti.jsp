...
<%
            String nomePagina = "RelazioniEnti";
...
<script type="text/javascript" src="<%=basePath%>javascript/pages/relazioniEnti.jsp?nomePagina=<%=nomePagina%>&set_id=<%=set_id%>"></script>
<title>Relazioni enti</title>
</head>
<body>
    <div id="wrapper">
