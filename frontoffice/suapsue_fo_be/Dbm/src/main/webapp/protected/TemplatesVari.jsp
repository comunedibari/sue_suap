...
<%
            String nomePagina = "TemplatesVari";
...
<script type="text/javascript" src="<%=basePath%>javascript/pages/templatesVari.jsp?nomePagina=<%=nomePagina%>&set_id=<%=set_id%>"></script>
<title>Templates generici</title>
</head>
<body>
    <div id="wrapper">
