...
<%
            String nomePagina = "OneriGerarchia";
...
<script type="text/javascript" src="<%=basePath%>javascript/pages/oneriGerarchia.jsp?nomePagina=<%=nomePagina%>&set_id=<%=set_id%>"></script>
<title>Gerarchia Oneri</title>
</head>
<body>
    <div id="wrapper">
