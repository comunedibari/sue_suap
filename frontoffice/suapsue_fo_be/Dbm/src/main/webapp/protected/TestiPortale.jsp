...
<%
            String nomePagina = "TestiPortale";
...
<script type="text/javascript" src="<%=basePath%>javascript/pages/testiPortale.jsp?nomePagina=<%=nomePagina%>&set_id=<%=set_id%>"></script>
<title>Testi Portale</title>
</head>
<body>
    <div id="wrapper">
