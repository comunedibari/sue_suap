...
<%
            String nomePagina = "GerarchiaOperazioni";
...
<script type="text/javascript" src="<%=basePath%>javascript/pages/gerarchiaOperazioni.jsp?nomePagina=<%=nomePagina%>&set_id=<%=set_id%>"></script>
<title>Gerarchia operazioni</title>
</head>
<body>
    <div id="wrapper">
