...
<%
            String nomePagina = "InterventiCollegati";
...
<script type="text/javascript" src="<%=basePath%>javascript/pages/interventiCollegati.jsp?nomePagina=<%=nomePagina%>&set_id=<%=set_id%>"></script>
<title>Interventi collegati</title>
</head>
<body>
    <div id="wrapper">
