...
<%
            String nomePagina = "AttributiIntervento";
...
<script type="text/javascript" src="<%=basePath%>javascript/pages/attributiIntervento.jsp?nomePagina=<%=nomePagina%>&set_id=<%=set_id%>"></script>
<title>AttributiIntervento</title>
