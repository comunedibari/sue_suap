...
<%
            String nomePagina = "TipiNormative";
...
<script type="text/javascript" src="<%=basePath%>javascript/pages/tipiRif.jsp?nomePagina=<%=nomePagina%>&set_id=<%=set_id%>"></script>
<title>Tipi Normative</title>
</head>
<body>
    <div id="wrapper">
