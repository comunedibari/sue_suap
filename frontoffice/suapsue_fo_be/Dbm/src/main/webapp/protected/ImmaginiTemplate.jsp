...
<%
            String nomePagina = "ImmaginiTemplate";
...
<script type="text/javascript" src="<%=basePath%>javascript/pages/immaginiTemplate.jsp?nomePagina=<%=nomePagina%>&set_id=<%=set_id%>"></script>
<title>Immagini template</title>
</head>
<body>
    <div id="wrapper">
