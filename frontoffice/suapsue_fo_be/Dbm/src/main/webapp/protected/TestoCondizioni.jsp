...
<%
            String nomePagina = "TestoCondizioni";
...
<script type="text/javascript" src="<%=basePath%>javascript/pages/testoCondizioni.jsp?nomePagina=<%=nomePagina%>&set_id=<%=set_id%>"></script>
<title>Testo condizioni</title>
</head>
<body>
    <div id="wrapper">
