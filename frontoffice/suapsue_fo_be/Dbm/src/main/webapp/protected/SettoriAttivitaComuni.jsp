...
<%
            String nomePagina = "SettoriAttivitaComuni";
...
<script type="text/javascript" src="<%=basePath%>javascript/pages/settoriAttivitaComuni.jsp?nomePagina=<%=nomePagina%>&set_id=<%=set_id%>"></script>
<title>Territorialit&agrave; Settori attivit&agrave;</title>
</head>
<body>
    <div id="wrapper">
