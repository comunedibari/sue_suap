...
<%
            String nomePagina = "CondizioniAttivazione";
...
<script type="text/javascript" src="<%=basePath%>javascript/pages/condizioniDiAttivazione.jsp?nomePagina=<%=nomePagina%>&set_id=<%=set_id%>"></script>
<title>Condizioni di attivazione</title>
</head>
<body>
    <div id="wrapper">
