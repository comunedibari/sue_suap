...
<%
            String nomePagina = "DuplicazioneInterventi";
...
<link rel="stylesheet" type="text/css" href="<%=basePath%>css/fileuploadField.css" />
...
<script type="text/javascript" src="<%=basePath%>javascript/lib/Extensions.js"></script>
<script type="text/javascript" src="<%=basePath%>javascript/lib/FileUploadField.js"></script>
<script type="text/javascript" src="<%=basePath%>javascript/lib/CheckColumn.js"></script>
...
<script type="text/javascript" src="<%=basePath%>javascript/pages/duplicazioneInterventi.jsp?nomePagina=<%=nomePagina%>&set_id=<%=set_id%>"></script>
<title>Duplicazione Interventi</title>
<%
    //Pulisco la sessione della variabile utilizzata per il caricamento dati da XML
    request.getSession().removeAttribute("importXMLVariables");
%>
</head>
<body>
    <div id="wrapper">
