...
<%
            String nomePagina = "SettoriAttivita";
...
<script type="text/javascript" src="<%=basePath%>javascript/pages/settoriAttivita.jsp?nomePagina=<%=nomePagina%>&set_id=<%=set_id%>"></script>
<title>Settori attivit&agrave;</title>
</head>
<body>
    <div id="wrapper">
