...
<%
            String nomePagina = "InterventiComuni";
...
<script type="text/javascript" src="<%=basePath%>javascript/pages/interventiComuni.jsp?nomePagina=<%=nomePagina%>&set_id=<%=set_id%>"></script>
<title>Territorialit&agrave; Interventi</title>
</head>
<body>
    <div id="wrapper">
