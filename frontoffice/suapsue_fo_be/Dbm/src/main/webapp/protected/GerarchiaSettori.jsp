...
<%
            String nomePagina = "GerarchiaSettori";
...
<script type="text/javascript" src="<%=basePath%>javascript/lib/Printer.js"></script>
<script type="text/javascript" src="<%=basePath%>javascript/renderers/Base.js"></script>
<script type="text/javascript" src="<%=basePath%>javascript/renderers/ColumnTree.js"></script>
...
<script type="text/javascript" src="<%=basePath%>javascript/pages/gerarchiaSettori.jsp?nomePagina=<%=nomePagina%>&set_id=<%=set_id%>"></script>
<title>Gerarchia settori attivit&agrave;</title>
</head>
<body>
    <div id="wrapper">
