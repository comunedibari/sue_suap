...
<script type="text/javascript" src="<%=basePath%>javascript/pages/classiEnti.jsp?nomePagina=<%=nomePagina%>&set_id=<%=set_id%>"></script>
<title>Classi Enti</title>
</head>
<body>
    <div id="wrapper">
