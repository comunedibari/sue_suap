...
<script type="text/javascript" src="<%=basePath%>javascript/pages/oneriCampi.jsp?nomePagina=<%=nomePagina%>&set_id=<%=set_id%>"></script>
<title>Campi formule oneri</title>
</head>
<body>
    <div id="wrapper">
