...
<%
            String nomePagina = "Procedimenti";
...
<script type="text/javascript" src="<%=basePath%>javascript/pages/procedimenti.jsp?nomePagina=<%=nomePagina%>&set_id=<%=set_id%>"></script>
<title>Procedimenti</title>
</head>
<body>
    <div id="wrapper">
