...
<%
            String nomePagina = "LingueAggregazioni";
...
<script type="text/javascript" src="<%=basePath%>javascript/pages/lingueAggregazioni.jsp?nomePagina=<%=nomePagina%>&set_id=<%=set_id%>"></script>
<title>Lingue Aggregazioni</title>
</head>
<body>
    <div id="wrapper">
