...
<%
            String nomePagina = "ComuniAggregazione";
...
<script type="text/javascript" src="<%=basePath%>javascript/pages/comuniAggregazione.jsp?nomePagina=<%=nomePagina%>&set_id=<%=set_id%>"></script>
<title>Comuni Aggregazione</title>
</head>
<body>
    <div id="wrapper">
