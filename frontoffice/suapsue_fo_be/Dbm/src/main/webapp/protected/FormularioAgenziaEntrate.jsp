...
<%
            String nomePagina = "FormularioAgenziaEntrate";
...
<script type="text/javascript" src="<%=basePath%>javascript/pages/formularioAgenziaEntrate.jsp?nomePagina=<%=nomePagina%>&set_id=<%=set_id%>"></script>
<title>Formulario Agenzia Entrate</title>
</head>
<body>
    <div id="wrapper">
