...
<%
            String nomePagina = "OneriFormula";
...
<script type="text/javascript" src="<%=basePath%>javascript/pages/oneriFormula.jsp?nomePagina=<%=nomePagina%>&set_id=<%=set_id%>"></script>
<title>Formula oneri</title>
</head>
<body>
    <div id="wrapper">
