...
<script type="text/javascript" src="<%=basePath%>javascript/pages/oneriComuni.jsp?nomePagina=<%=nomePagina%>&set_id=<%=set_id%>"></script>
<title>Territorialit&agrave; Oneri</title>
</head>
<body>
    <div id="wrapper">
