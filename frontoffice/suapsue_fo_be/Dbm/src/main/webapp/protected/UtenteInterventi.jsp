...
<%
            String nomePagina = "UtentiInterventi";
...
<script type="text/javascript" src="<%=basePath%>javascript/pages/utentiInterventi.jsp?nomePagina=<%=nomePagina%>&set_id=<%=set_id%>"></script>
<title>Utenti Interventi</title>
</head>
<body>
    <div id="wrapper">
