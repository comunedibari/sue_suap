...
<script type="text/javascript" src="<%=basePath%>javascript/pages/entiComuni.jsp?nomePagina=<%=nomePagina%>&set_id=<%=set_id%>"></script>
<title>Enti / Comuni</title>
</head>
<body>
    <div id="wrapper">
