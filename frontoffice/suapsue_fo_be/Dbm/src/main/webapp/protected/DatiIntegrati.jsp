...
<%
            String nomePagina = "DatiIntegrati";
...
<script type="text/javascript" src="<%=basePath%>javascript/pages/datiIntegrati.jsp?nomePagina=<%=nomePagina%>&set_id=<%=set_id%>"></script>
<title>Dati Integrati</title>
</head>
<body>
    <div id="wrapper">
