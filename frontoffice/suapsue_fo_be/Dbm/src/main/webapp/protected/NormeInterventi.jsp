...
<%
            String nomePagina = "NormeInterventi";
...
<script type="text/javascript" src="<%=basePath%>javascript/pages/normeInterventi.jsp?nomePagina=<%=nomePagina%>&set_id=<%=set_id%>"></script>
<title>Norme interventi</title>
</head>
<body>
    <div id="wrapper">
