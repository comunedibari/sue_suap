...
<%
            String nomePagina = "AllegatiComuni"; 
...
<script type="text/javascript" src="<%=basePath%>javascript/pages/allegatiComuni.jsp?nomePagina=<%=nomePagina%>&set_id=<%=set_id%>"></script>
<title>Allegati comuni</title>
</head>
<body>
    <div id="wrapper">
