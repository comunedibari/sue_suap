...
<%
            String nomePagina = "CondizioniNormative";
...
<script type="text/javascript" src="<%=basePath%>javascript/pages/condizioniNormative.jsp?nomePagina=<%=nomePagina%>&set_id=<%=set_id%>"></script>
<title>Norme su condizioni</title>
</head>
<body>
    <div id="wrapper">
