...
<script type="text/javascript" src="<%=basePath%>javascript/pages/normeComuni.jsp?nomePagina=<%=nomePagina%>&set_id=<%=set_id%>"></script>
<title>Territorialit&agrave; Normative</title>
</head>
<body>
    <div id="wrapper">
