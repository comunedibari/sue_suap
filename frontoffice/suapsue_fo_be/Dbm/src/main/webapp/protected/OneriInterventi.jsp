...
<%
            String nomePagina = "OneriInterventi";
...
<script type="text/javascript" src="<%=basePath%>javascript/pages/oneriInterventi.jsp?nomePagina=<%=nomePagina%>&set_id=<%=set_id%>"></script>
<title>Oneri interventi</title>
</head>
<body>
    <div id="wrapper">
