...
<%
            String nomePagina = "SequenzaInterventi";
...
<script type="text/javascript" src="<%=basePath%>javascript/pages/sequenzaInterventi.jsp?nomePagina=<%=nomePagina%>&set_id=<%=set_id%>"></script>
<title>Sequenza interventi</title>
</head>
<body>
    <div id="wrapper">
