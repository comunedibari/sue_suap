...
<%
            String nomePagina = "OneriDocumenti";
...
<script type="text/javascript" src="<%=basePath%>javascript/pages/oneriDocumenti.jsp?nomePagina=<%=nomePagina%>&set_id=<%=set_id%>"></script>
<title>Documenti oneri</title>
</head>
<body>
    <div id="wrapper">
