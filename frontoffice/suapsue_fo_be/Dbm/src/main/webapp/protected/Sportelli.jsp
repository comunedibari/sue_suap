...
<script type="text/javascript" src="<%=basePath%>javascript/lib/RowEditor.js"></script>
...
<script type="text/javascript" src="<%=basePath%>javascript/pages/sportelli.jsp?nomePagina=<%=nomePagina%>&set_id=<%=set_id%>"></script>
