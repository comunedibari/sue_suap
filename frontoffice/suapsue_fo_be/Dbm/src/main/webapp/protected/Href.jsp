...
<script type="text/javascript" src="<%=basePath%>javascript/lib/RowExpander.js"></script>
...
<script type="text/javascript" src="<%=basePath%>javascript/pages/href.jsp?nomePagina=<%=nomePagina%>&set_id=<%=set_id%>"></script>
<title>Dichiarazioni dinamiche</title>
</head>
<body>
    <div id="wrapper">
