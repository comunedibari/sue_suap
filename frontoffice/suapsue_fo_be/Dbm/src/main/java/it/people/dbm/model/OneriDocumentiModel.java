 ...
 * @author Piergiorgio
 */
public class OneriDocumentiModel implements java.io.Serializable {

    public String codDocOnere;
    public String desDocOnere;
    public String tipAggregazione;
    ...
    public String getCodDocOnere() {
        return codDocOnere;
    }

    public void setCodDocOnere(String codDocOnere) {
        this.codDocOnere = codDocOnere;
    }

    public String getDesDocOnere() {
        return desDocOnere;
    }

    public void setDesDocOnere(String desDocOnere) {
        this.desDocOnere = desDocOnere;
    }
