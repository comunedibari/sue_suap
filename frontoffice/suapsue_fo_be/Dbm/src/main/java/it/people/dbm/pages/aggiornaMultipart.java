 ...
 * @author Piergiorgio
 */
public class aggiornaMultipart extends HttpServlet {
...
//            FileItemIterator iter = upload.getItemIterator(request);
            ...
            if (action.equals("templates_vari_risorse")) {
                TemplateVariModel tm = caricaTemplatesVariRisorse(parameters);
    ...
    private OneriDocumentiModel caricaOneriDocumenti(HashMap<String, FileItem> parameters) throws Exception {
        ...
        parameter = parameters.get("tip_aggregazione");
        odm.setTipAggregazione(parameter.getString());
    ...
    private ImmagineModel caricaImmagine(HashMap<String, FileItem> parameters) throws Exception {
        ...
        parameter = parameters.get("document_path");
        FileUploadModel uf = UploadFile.upload(parameter);
        tm.setNomeFile(uf.getNomeFile());
        tm.setImmagine(Base64.encodeBase64(Utility.byteArrayInputStreamToByteArray(uf.getDocBlob())));
        tm.setTipoFile(uf.getTipDoc());

        return tm;
    }

    private TemplateVariModel caricaTemplatesVariRisorse(HashMap<String, FileItem> parameters) throws Exception {
        ...
        FileUploadModel uf = UploadFile.upload(parameter);
        tm.setNomeFile(uf.getNomeFile());
        tm.setTemplateVariRisorse(Base64.encodeBase64(Utility.byteArrayInputStreamToByteArray(uf.getDocBlob())));
        tm.setTipoFile(uf.getTipDoc());
...
// <editor-fold defaultstate="collapsed" desc="HttpServlet methods. Click on the + sign on the left to edit the code.">
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(aggiornaMultipart.class.getName()).log(Level.SEVERE, null, ex);
        }
