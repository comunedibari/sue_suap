...
public boolean modificaIntervento;

    public boolean isModificaIntervento() {
        return modificaIntervento;
    }

    public void setModificaIntervento(boolean modificaIntervento) {
        this.modificaIntervento = modificaIntervento;
    }
    ...
    public void init() {
        this.setModificaIntervento(false);
