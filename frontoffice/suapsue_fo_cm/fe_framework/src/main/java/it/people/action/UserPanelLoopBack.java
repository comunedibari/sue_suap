...
public class UserPanelLoopBack extends Action {

    private static final Logger logger = LogManager
	    .getLogger(UserPanelLoopBack.class);
	...
	if (pplProcess.isInizialized()) {
	    ...
	    String parameter = (String) p_httpServletRequest
	    ...
	    pplProcess.getView().userPanelLoopBack(pplProcess, requestWrapper,
		    parameter);
