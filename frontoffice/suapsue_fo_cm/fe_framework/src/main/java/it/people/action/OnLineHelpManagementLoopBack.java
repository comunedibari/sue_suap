...
public class OnLineHelpManagementLoopBack extends Action {

    private static final Logger logger = LogManager
	    .getLogger(OnLineHelpManagementLoopBack.class);
	...
	if (propertyName == null) {
	    // il loopback è stato invocato da un pulsante di submit
	...
	if (pplProcess.isInizialized()) {
	    ...
	    pplProcess.getView().onLineHelpManagementLoopBack(pplProcess,
		    requestWrapper, propertyName);
