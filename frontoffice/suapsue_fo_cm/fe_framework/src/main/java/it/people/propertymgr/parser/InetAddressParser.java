 ...
 */
public class InetAddressParser extends ApplicationPropertyParser {
    /**
     * TimeInterval constructor comment.
     */
    public InetAddressParser() {
	super();
    }
	...
	return ((InetAddress) p_obj_object).toString();
    }
	...
	try {
	    return InetAddress.getByName(p_str_value.trim());
	} catch (Exception e) {
