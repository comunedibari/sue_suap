...
/**
 * Created by IntelliJ IDEA. User: acuffaro Date: 25-nov-2003 Time: 10.40.07 To
 * change this template use Options | File Templates.
 */
public class GenericFiscalNumberValidator extends ObjectValidator {

    public GenericFiscalNumberValidator() {
    }

    public GenericFiscalNumberValidator(boolean p_required) {
	super(p_required);
    }
	...
	if (p_obj == null
	    ...
	    String messageCodF = ControllaCF(p_obj.toString());
	    String messagePIva = ControllaPartitaIva(p_obj.toString());
	    if (messagePIva.equals("") || messageCodF.equals("")) {
		// verifica eseguita senza errori
		return true;
	    } else {
		// verifica eseguita con errori
		throw new ParserException(
			"Il codice inserito non � n� un codice fiscale valido, n� una partita iva valida.");
	    }
	}
	/*
	 * else{ // se oggetto � nullo ma non obbligatorio restituisco true
	 * return true; }
	 */
    }
