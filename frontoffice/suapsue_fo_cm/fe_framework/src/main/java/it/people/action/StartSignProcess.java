...
/**
 * 
 * User: sergio Date: Nov 27, 2003 Time: 5:02:44 PM <br>
 * <br>
 * Inizializza lo step di firma.
 */
public class StartSignProcess extends Action {

    private Category cat = Category.getInstance(StartSignProcess.class
	    .getName());
	...
	try {
		...
		ProcessManager.getInstance().set(
			PeopleContext.create(p_httpServletRequest), pplProcess);
