 ...
 * 
 */
public class ConfigSenderPersistanceMgr extends PersistenceManager {
    public ConfigSenderPersistanceMgr() {
	super(PersistenceManager.Mode.READ);
    }

    public ConfigSenderPersistanceMgr(PersistenceManager.Mode p_obj_mode) {
	super(PersistenceManager.Mode.READ);
    }
