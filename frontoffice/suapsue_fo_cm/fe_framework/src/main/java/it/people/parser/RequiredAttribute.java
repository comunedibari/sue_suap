...
/**
 * Created by IntelliJ IDEA. User: sergio Date: Sep 9, 2003 Time: 10:22:22 AM To
 * change this template use Options | File Templates.
 */
public class RequiredAttribute implements FieldValidator {
	...
	if (p_obj instanceof String)
	    return (p_obj != null && ((String) p_obj).length() > 0);
	return (p_obj != null);
    }
