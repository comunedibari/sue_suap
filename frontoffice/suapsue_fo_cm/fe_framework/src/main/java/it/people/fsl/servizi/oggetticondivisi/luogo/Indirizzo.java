...
public class Indirizzo extends AbstractEntity {
     ...
     */
    public int getPiano() {
	return (piano != null && !piano.equalsIgnoreCase("")) ? Integer
		.parseInt(piano) : 0;
	// return Integer.parseInt(piano);
    }

    /**
     * @return
     */
    public String getPianoS() {
	return piano;
    }
	...
	piano = String.valueOf(i);
    }

    /**
     * @param i
     */
    public void setPiano(String i) {
	piano = i;
    }
