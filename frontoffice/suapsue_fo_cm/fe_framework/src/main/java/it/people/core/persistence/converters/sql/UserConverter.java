...
/**
 * Created by IntelliJ IDEA. User: sergio Date: Sep 19, 2003 Time: 11:44:32 AM
 * To change this template use Options | File Templates.
 */
public class UserConverter implements FieldConversion {
    public Object javaToSql(Object o) throws ConversionException {
	if (o instanceof PplUser)
	    return ((PplUser) o).getUserID();
	return null;
    }
