...
public class ProfiloPersonaGiuridica implements Serializable {
	...
	this.rappresentanteLegale = new ProfiloPersonaFisica(
		ppg.rappresentanteLegale);
    }
	...
	StringBuilder buffer = new StringBuilder()
		.append("Dati persona giuridica:")
		.append("\tDenominazione: " + this.getDenominazione())
		.append("\tDescrizione: " + this.getDescrizione())
		.append("\tSede legale: " + this.getSedeLegale())
		.append("\tCodice fiscale: " + this.getCodiceFiscale())
		.append("\tPartita IVA: " + this.getPartitaIva())
		.append("\tDomicilio elettronico: "
			+ this.getDomicilioElettronico())
		.append("\tDati rappresentante legale:");

	if (this.getRappresentanteLegale() != null) {
	    buffer.append(
		    "\t\tNome: " + this.getRappresentanteLegale().getNome())
		    .append("\t\tCognome: "
			    + this.getRappresentanteLegale().getCognome())
		    .append("\t\tCodice fiscale: "
			    + this.getRappresentanteLegale().getCodiceFiscale())
		    .append("\t\tSesso: "
			    + this.getRappresentanteLegale().getSesso())
		    .append("\t\tData nascita: "
			    + this.getRappresentanteLegale()
				    .getDataNascitaString())
		    .append("\t\tLuogo nascita: "
			    + this.getRappresentanteLegale().getLuogoNascita())
		    .append("\t\tProvincia nascita: "
			    + this.getRappresentanteLegale()
				    .getProvinciaNascita())
		    .append("\t\tIndirizzo residenza: "
			    + this.getRappresentanteLegale()
