 ...
 */
public class CommandRemoveObjectTag extends LinkTag {
    protected final static String REMOVE_OBJECT_ACTION_NAME = "removeObject";
	...
	String actionUrl = REMOVE_OBJECT_ACTION_NAME + ".do" + "?propertyName="
		+ this.property;
