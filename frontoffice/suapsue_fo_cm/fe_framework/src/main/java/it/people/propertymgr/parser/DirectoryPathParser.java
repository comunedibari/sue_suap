...
/**
 * Insert the type's description here. Creation date: (03/04/2004 17.44.36)
 * 
 * @author: giovanni agazzi
 */
public class DirectoryPathParser extends ApplicationPropertyParser {
     ...
     * TimeInterval constructor comment.
     */
    public DirectoryPathParser(boolean p_b_create) {
	super();
