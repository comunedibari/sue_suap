...
public class Provvedimento extends AbstractEntity {
    ...
    /**
     * @param annodiApplicazione
     *            The annodiApplicazione to set.
     */
    ...
    /**
     * @param datadelProvvedimento
     *            The datadelProvvedimento to set.
     */
    ...
    /**
     * @param differenzatraDovutoeVersato
     *            The differenzatraDovutoeVersato to set.
     */
    ...
    /**
     * @param importoVersato
     *            The importoVersato to set.
     */
     ...
     * 
     *         "Emesso" "Notificato" "Sospeso" "Pagato" "Annullato
     *         "A Ruolo Coattivo"
     * 
     ...
     *            "A Ruolo Coattivo"
     * 
     *            These values are declared in the inner class
     *            StatoProvvedimento.
     */
