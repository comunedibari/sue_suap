...
/**
 * 
 * User: sergio Date: Sep 8, 2003 Time: 3:55:01 PM <br>
 * <br>
 * La classe permette di navigare allo step precedente a quello corrente
 */
public class PrevStepProcess extends Action {

    private Category cat = Category
	    .getInstance(PrevStepProcess.class.getName());
