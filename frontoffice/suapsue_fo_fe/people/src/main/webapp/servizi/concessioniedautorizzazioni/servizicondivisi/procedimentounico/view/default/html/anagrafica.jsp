...
<logic:notEqual value="true" name="pplProcess" property="data.internalError">
    ...
    <table  style="border:1px solid #EAEAEA; padding: 5px; width:96%;">
        ...
        <logic:notEmpty name="pplProcess" property="data.anagrafica.htmlHistory">
            <logic:iterate id="rowsId" name="pplProcess" property="data.anagrafica.htmlHistory">
                <tr>
                    <td bgcolor="#DDFFFF" >
                        <bean:write name="rowsId" filter="yes" />
                    </td>
                </tr>
            </logic:iterate>
        </logic:notEmpty>
        <logic:equal value="false" name="pplProcess" property="data.anagrafica.fineCompilazione">
            <tr>
                <td style="border:2px dotted black; padding: 3px;"><bean:write name="pplProcess" property="data.anagrafica.htmlStepAttuale" filter="yes" /></td>
            </tr>
        </logic:equal>
        <tr>
            <td>
        ...
        <tr>
            <td>
                <logic:notEmpty name="INDIETRO" scope="request">
                    <ppl:commandLoopback commandProperty="indietroAnagrafica" styleClass="button_AeC_operazioni" >
                        &#60;&#60;&nbsp;<bean:message key="keyloopback.sceltaAnagraficaPrecedente"/>&nbsp;
                    </ppl:commandLoopback>
                </logic:notEmpty>
                <logic:notEmpty name="AVANTI" scope="request">
                    <ppl:commandLoopback commandProperty="avantiAnagrafica" validate="true" styleClass="button_AeC_operazioni" >
    ...
    <table align="center">
        <tr>
			...
			value="TORNA AL MODELLO UNICO" /-->
                <ppl:linkLoopback accesskey="B" property="modelloUnico.jsp&href=ANAG" styleClass="btn"><b>&nbsp;TORNA&nbsp;AL&nbsp;MODELLO&nbsp;UNICO&nbsp;</b></ppl:linkLoopback>
            </td>
        </tr>
    </table>
    <input type="hidden" value="ANAG" name="href"/>
</logic:notEqual>
