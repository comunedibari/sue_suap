...
// $Id: calendar.js,v 1.1 2009/12/03 15:04:31 mirkoc Exp $
...
Calendar.isRelated = function (el, evt) {
	...
	while (related) {
		...
		try {
			...
			if ((related = related.parentNode) == el)
			return true;
			return false;
...
Calendar.calDragIt = function (ev) {
	...
	var posY;
	if (Calendar.is_ie) {
		posY = window.event.clientY + Calendar.getViewportScrollY();
		posX = window.event.clientX + Calendar.getViewportScrollX();
	} else {
		posX = ev.pageX;
		posY = ev.pageY;
	}
