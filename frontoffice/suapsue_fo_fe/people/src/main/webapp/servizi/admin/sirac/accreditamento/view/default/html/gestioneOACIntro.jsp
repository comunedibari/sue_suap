...
%>
  ...
  <div class="admin_sirac_accr_titolo">
      <bean:message key="label.gestioneOACIntro.info" />
  </div>
...
%>
    	<div class="text_block" align="left">
		    <h2>
		    <bean:message key="label.gestioneOACIntro.titolo" />
		    <ppl:errors />
		    </h2>
	  	</div>
			    ...
			    <tr>
			        <td>
			            <span class="FixTextLabel">
			            	Questa attivit&agrave; consente di gestire, da parte di un Rappresentante di Associazione di Categoria, 
			            	l'attivazione/disattivazione e l'eliminazione/ripristino dei soggetti che potranno<br> 
