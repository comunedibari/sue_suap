...
%>
  ...
  <div class="admin_sirac_accr_titolo">
      <bean:message key="label.creaDelegaIntro.info" />
  </div>
...
%>
    	<div class="text_block" align="left">
		    <h2>
		    <bean:message key="label.creaDelegaIntro.titolo" />
		    <ppl:errors />
		    </h2>
	  	</div>
			...
			<table class="maintable" border="0" cellspacing="1" width="100%">
			    <tr>
			        <td>
			            <span class="FixTextLabel">
			            	Questa attivit&agrave; consente di definire, da parte di un Rappresentante CAF, dei soggetti che potranno 
			            	successivamente operare per suo conto nell'accesso ai servizi per intermediari definiti presso questo ente.<br><br>
			    ...
			    <tr>
			        <%if ((pplProcess.getView()).isBottomNavigationBarEnabled()) { %>
			           <td>Selezionare 'Continua' per selezionare una tra le qualifiche "Rappresentante CAF" attive</td>
			        <% } else { %>
