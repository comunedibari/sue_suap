...
<c:choose>
  ...
  <c:otherwise>
         ...
         <div class="admin_sirac_autocert_body">
           Io sottoscritto <c:out value='${datiAutoCertMap["nome"]}'/>  <c:out value='${datiAutoCertMap["cognome"]}' /> 
           <br/><br/>
           ...
           <br/><br/>
           <ul>
           		<li>ai sensi e per gli effetti dell'art. 46 del D.P.R. 28/12/2006 n. 445;</li>
           		<li>consapevole delle sanzioni penali in caso di dichiarazioni non 
           		veritiere richiamate dall'art. 76 del D.P.R. 28/12/2006 n. 445;</li>
           		<li>consapevole che ai sensi art. 75 del D.P.R. 28/12/2006 n. 445 ove emerga la 
           		non veridicit&agrave; del contenuto della dichiarazione, il dichiarante decade dai 
           		benefici eventualmente conseguenti al provvedimento emanato sulla base della 
           		dichiarazione non veritiera;</li>
           </ul>
           <br/>
         </div>
        <div class="admin_sirac_autocert_title">DICHIARO</div>
        <br/>
        <div class=admin_sirac_autocert_body 
