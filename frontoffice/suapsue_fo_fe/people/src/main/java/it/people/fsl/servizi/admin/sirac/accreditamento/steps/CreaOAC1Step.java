 ...
 */
public class CreaOAC1Step extends Step {

  private static Logger logger = LoggerFactory.getLogger(CreaOAC1Step.class.getName());
  ...
  public void service(AbstractPplProcess process, IRequestWrapper request)
    ...
    try {
		...
		if (profilo == null) {
			rwh.addSiracError("CreaOAC1Step::Errore1", "Non esiste un profilo locale per l'utente " + codiceFiscaleUtente);
...
//      }
      ...
      rwh.addSiracError("CreaOAC1Step::Service()::Errore", ex.getMessage());
    } finally {
      updateWorkflow(process);
    }
  }
