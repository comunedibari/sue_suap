...
public class ProfileSelectServlet extends HttpServlet {
	  ...
	  public void doPost(HttpServletRequest request, HttpServletResponse response)
	    ...
	    String resource = "/initProcess.do?processName=it.people.fsl.servizi.admin.sirac.accreditamento&selAccr=true";
