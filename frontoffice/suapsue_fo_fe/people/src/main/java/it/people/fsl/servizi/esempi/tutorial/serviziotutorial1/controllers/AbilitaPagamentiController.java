...
/**
 * Classe che verifica l'accesso allo step di pagamento
 * @author Fabbri Michele

 */
public class AbilitaPagamentiController implements WorkflowController {
	public boolean canEnter(PplData p_processData) {
		if (p_processData instanceof ProcessData)
			return ((ProcessData)p_processData).isAbilitaPagamenti();
		return false;
	}
}
