 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class PaginaIntermedia extends Step {	
	public void service(AbstractPplProcess process, IRequestWrapper request)
			throws IOException, ServletException {
        ProcessData tutorialData = (ProcessData)process.getData();
        
        tutorialData.setOggettoPratica("Oggetto2 TEST");
        tutorialData.setDescrizionePratica("Descrizione2 Test"); 
	    process.debug("Accesso alla pagina intermedia.");
	}
}
