...
import it.people.fsl.servizi.concessioniedautorizzazioni.servizicondivisi.procedimentounico.steps.ModelloUnicoStep;
 ...
 * 16-giu-2006
 */
public class CreateSinglePdfWhite extends BaseStep {
    ...
    public byte[] stampaPdf(AbstractPplProcess process, IRequestWrapper request){
        ...
        try{
            ...
            String stringaObbligatorio = p.getProperty("pdfBlank.stringaObbligatorio");
            if(stringaObbligatorio == null || stringaObbligatorio.equalsIgnoreCase("")){
                stringaObbligatorio = "(*)";
            }
            
            Image jpgFlg = null;
            try{
                jpgFlg = Image.getInstance(absPathToService
                                                + System.getProperty("file.separator")
                                                + System.getProperty("file.separator")
                                                + "risorse"
                                                + System.getProperty("file.separator")
                ...
                // Per debug
                jpgFlg = Image.getInstance("E:\\eclipse\\eclipse3.0\\workspace\\People-2.0\\web\\WEB-INF\\classes\\it\\people\\fsl\\servizi\\concessioniedautorizzazioni\\servizicondivisi\\procedimentounico\\risorse\\img\\check_flag.JPG");
            }
            
            Image jpg = null;
            try{
                //Image jpg = Image.getInstance(absPathToService+"\\risorse\\img\\check.JPG");
                jpg = Image.getInstance(absPathToService
                                                + System.getProperty("file.separator")
                                                + "risorse"
                                                + System.getProperty("file.separator")
                                                + "img"
                ...
                // Per debug
                jpg = Image.getInstance("E:\\eclipse\\eclipse3.0\\workspace\\People-2.0\\web\\WEB-INF\\classes\\it\\people\\fsl\\servizi\\concessioniedautorizzazioni\\servizicondivisi\\procedimentounico\\risorse\\img\\check.JPG");
            }
            ...
            sportUnico = sportUnico.replaceAll("<br/>", "\n");
            oggetto[2] = new Paragraph(sportUnico, normalFont);
            ...
            cell = new PdfPCell(new Paragraph(StringEscapeUtils.unescapeHtml(p.getProperty("mu.sottoscritto"))+stringaObbligatorio, normalFont));
            cell.setColspan(4);
            cell.setGrayFill(0.90f);
            table.addCell(cell);
            ...
            cell = new PdfPCell(new Paragraph(StringEscapeUtils.unescapeHtml(p.getProperty("mu.natoa"))+stringaObbligatorio, normalFont));
            cell.setColspan(4);
            cell.setGrayFill(0.90f);
            table.addCell(cell);
            ...
            cell = new PdfPCell(new Paragraph(StringEscapeUtils.unescapeHtml(p.getProperty("mu.nato.il"))+stringaObbligatorio, normalFont));
            cell.setColspan(2);
            cell.setGrayFill(0.90f);
            table.addCell(cell);
            ...
            cell.setColspan(2);
            table.addCell(cell);
            cell = new PdfPCell(new Paragraph(StringEscapeUtils.unescapeHtml(p.getProperty("mu.cf"))+stringaObbligatorio, normalFont));
            cell.setColspan(2);
            cell.setGrayFill(0.90f);
            table.addCell(cell);
            ...
            cell = new PdfPCell(new Paragraph(StringEscapeUtils.unescapeHtml(p.getProperty("mu.residente"))+stringaObbligatorio, normalFont));
            cell.setColspan(3);
            cell.setGrayFill(0.90f);
            table.addCell(cell);
            ...
            cell = new PdfPCell(new Paragraph(StringEscapeUtils.unescapeHtml(p.getProperty("mu.residente.via"))+stringaObbligatorio, normalFont));
            cell.setColspan(4);
            cell.setGrayFill(0.90f);
            table.addCell(cell);
            ...
            table = new PdfPTable(8);
            table.setWidthPercentage(100);
            aggiungiSpazi(document, 0);

            Paragraph[] descCompilazione = new Paragraph[2];
            descCompilazione[0] = new Paragraph(StringEscapeUtils.unescapeHtml(p.getProperty("pdfBlank.istruzioni1")), normalFont);
            descCompilazione[1] = new Paragraph(" ");
            for (int i = 0; i < 2; i++) {
                document.add(descCompilazione[i]);
                ...
                //if(dataForm.getAnagrafica().getDichiarante().getAgiscePerContoDi().equalsIgnoreCase("0")){
                    cell = new PdfPCell(new Paragraph(StringEscapeUtils.unescapeHtml(p.getProperty("pdfBlank.rappSocieta")), boldFont));
                    cell.setColspan(8);
                    table.addCell(cell);
            
                    HashMap hmCombo = getContenutocomboRappresentanze(session);
                    LinkedList lista = (LinkedList) hmCombo.get("comboImpresa");
                    
                    cell = new PdfPCell(new Paragraph(StringEscapeUtils.unescapeHtml(p.getProperty("label.anagrafica.motivazione"))+stringaObbligatorio, normalFont));
                    cell.setColspan(4);
                    cell.setGrayFill(0.90f);
                    table.addCell(cell);
                    /*if(dataForm.getAnagrafica().getAttivita().getCodiceMotivazioneRappresentanza()!=null){ 
                        ...
                        dato = convertiLista(lista);
                    //}
                    cell = new PdfPCell(new Paragraph(dato, boldFont));
                    cell.setColspan(4);
                    table.addCell(cell);
                    
                    cell = new PdfPCell(new Paragraph(StringEscapeUtils.unescapeHtml(p.getProperty("mu.impresa"))+stringaObbligatorio, normalFont));
                    cell.setColspan(4);
                    cell.setGrayFill(0.90f);
                    table.addCell(cell);
                    ...
                    cell = new PdfPCell(new Paragraph(StringEscapeUtils.unescapeHtml(p.getProperty("mu.sede.legale"))+stringaObbligatorio, normalFont));
                    cell.setColspan(2);
                    cell.setGrayFill(0.90f);
                    table.addCell(cell);
                    ...
                    cell.setColspan(2);
                    table.addCell(cell);
                    cell = new PdfPCell(new Paragraph(StringEscapeUtils.unescapeHtml(p.getProperty("mu.cap"))+stringaObbligatorio, normalFont));
                    cell.setColspan(2);
                    cell.setGrayFill(0.90f);
                    table.addCell(cell);
                    ...
                    cell = new PdfPCell(new Paragraph(StringEscapeUtils.unescapeHtml(p.getProperty("mu.via"))+stringaObbligatorio, normalFont));
                    cell.setColspan(4);
                    cell.setGrayFill(0.90f);
                    table.addCell(cell);
                    ...
                    cell.setColspan(2);
                    table.addCell(cell);
                    cell = new PdfPCell(new Paragraph(StringEscapeUtils.unescapeHtml(p.getProperty("mu.piva"))+stringaObbligatorio, normalFont));
                    cell.setColspan(2);
                    cell.setGrayFill(0.90f);
                    table.addCell(cell);
                ...
                //else if(dataForm.getAnagrafica().getDichiarante().getAgiscePerContoDi().equalsIgnoreCase("2")){
                    cell = new PdfPCell(new Paragraph(StringEscapeUtils.unescapeHtml(p.getProperty("pdfBlank.rappPrivato")), boldFont));
                    cell.setColspan(8);
                    table.addCell(cell);
                    ...
                    /*if(dataForm.getAnagrafica().getDatiPersonaDeleganteBean().getCodiceMotivazioneRappresentanza()!=null){ 
                        ...
                        lista = (LinkedList) hmCombo.get("comboPrivato");
                        dato = convertiLista(lista);
                    //}
                    cell = new PdfPCell(new Paragraph(dato, boldFont));
                    cell.setColspan(4);
                    ...
                    cell = new PdfPCell(new Paragraph(StringEscapeUtils.unescapeHtml(p.getProperty("mu.signore"))+stringaObbligatorio, normalFont));
                    cell.setColspan(4);
                    cell.setGrayFill(0.90f);
                    table.addCell(cell);
                    ...
                    cell = new PdfPCell(new Paragraph(StringEscapeUtils.unescapeHtml(p.getProperty("mu.il"))+stringaObbligatorio, normalFont));
                    cell.setColspan(2);
                    cell.setGrayFill(0.90f);
                    table.addCell(cell);
                ...
                //else if(dataForm.getAnagrafica().getDichiarante().getAgiscePerContoDi().equalsIgnoreCase("3")){
                    ...
                    cell = new PdfPCell(new Paragraph(StringEscapeUtils.unescapeHtml(p.getProperty("pdfBlank.rappEnte")), boldFont));
                    cell.setColspan(8);
                    table.addCell(cell);
                    ...
                    /*if(dataForm.getAnagrafica().getDatiAziendaNoProfitDeleganteBean().getCodiceMotivazioneRappresentanza()!=null){ 
                        ...
                        lista = (LinkedList) hmCombo.get("comboAltroEnte");
                        dato = convertiLista(lista);
                    //}
                    cell = new PdfPCell(new Paragraph(dato, boldFont));
                    cell.setColspan(4);
                    ...
                    cell = new PdfPCell(new Paragraph(StringEscapeUtils.unescapeHtml(p.getProperty("mu.sedelegalein"))+stringaObbligatorio, normalFont));
                    cell.setColspan(2);
                    cell.setGrayFill(0.90f);
                    table.addCell(cell);
                ...
                //else if(dataForm.getAnagrafica().getDichiarante().getAgiscePerContoDi().equalsIgnoreCase("4")){
                    cell = new PdfPCell(new Paragraph(StringEscapeUtils.unescapeHtml(p.getProperty("pdfBlank.rappProfessioista")), boldFont));
                    cell.setColspan(8);
                    table.addCell(cell);
                    
                    cell = new PdfPCell(new Paragraph(StringEscapeUtils.unescapeHtml(p.getProperty("label.anagrafica.tipoprofessione"))+stringaObbligatorio, normalFont));
                    cell.setColspan(4);
                    cell.setGrayFill(0.90f);
                    table.addCell(cell);
                    /*if(dataForm.getAnagrafica().getDatiProfessionistaBean().getCodiceMotivazioneRappresentanza()!=null){ 
                        ...
                        lista = (LinkedList) hmCombo.get("comboProfessionista");
                        dato = convertiLista(lista);
                    //}
                    cell = new PdfPCell(new Paragraph(dato, boldFont));
                    cell.setColspan(4);
                    ...
                    cell = new PdfPCell(new Paragraph(StringEscapeUtils.unescapeHtml(p.getProperty("label.iscrizionealbo"))+stringaObbligatorio, normalFont));
                    cell.setColspan(4);
                    cell.setGrayFill(0.90f);
                    table.addCell(cell);
                    /*if(dataForm.getAnagrafica().getDatiProfessionistaBean().getCodiceAlbo()!=null){ 
                        ...
                        lista = (LinkedList) hmCombo.get("comboAlbo");
                        dato = convertiLista(lista);
                    //}
                    cell = new PdfPCell(new Paragraph(dato, boldFont));
                    cell.setColspan(4);
                    ...
                    cell = new PdfPCell(new Paragraph(StringEscapeUtils.unescapeHtml(p.getProperty("label.professionista.numeroiscrizionealbo"))+stringaObbligatorio, normalFont));
                    cell.setColspan(2);
                    cell.setGrayFill(0.90f);
                    table.addCell(cell);
                    ...
                    cell.setColspan(1);
                    table.addCell(cell);
                    cell = new PdfPCell(new Paragraph(StringEscapeUtils.unescapeHtml(p.getProperty("label.professionista.provinciaiscrizionealbo"))+stringaObbligatorio, normalFont));
                    cell.setColspan(2);
                    cell.setGrayFill(0.90f);
                    table.addCell(cell);
                    ...
                    cell.setColspan(1);
                    table.addCell(cell);
                    cell = new PdfPCell(new Paragraph(StringEscapeUtils.unescapeHtml(p.getProperty("label.professionista.dataiscrizionealbo"))+stringaObbligatorio, normalFont));
                    cell.setColspan(1);
                    cell.setGrayFill(0.90f);
                    table.addCell(cell);
                    ...
                    /*if(dataForm.getAnagrafica().getDatiProfessionistaBean().getDelega().getCodiceCausaleDelega()!=null){ 
                        ...
                        lista = (LinkedList) hmCombo.get("comboCausaleDelega");
                        dato = convertiLista(lista, true);
                    //}
                    ...
                    cell = new PdfPCell(new Paragraph(StringEscapeUtils.unescapeHtml(p.getProperty("label.tramite"))+stringaObbligatorio, normalFont));
                    cell.setColspan(4);
                    cell.setGrayFill(0.90f);
                    table.addCell(cell);
                    /*if(dataForm.getAnagrafica().getDatiProfessionistaBean().getDelega().getCodiceTramiteDelega()!=null){ 
                        ...
                        lista = (LinkedList) hmCombo.get("comboTramiteDelega");
                        dato = convertiLista(lista);
                    //}
                    cell = new PdfPCell(new Paragraph(dato, boldFont));
                    cell.setColspan(4);
                    table.addCell(cell);
                    cell = new PdfPCell(new Paragraph(StringEscapeUtils.unescapeHtml(p.getProperty("label.sottoscritta"))+stringaObbligatorio, normalFont));
                    cell.setColspan(2);
                    cell.setGrayFill(0.90f);
                    table.addCell(cell);
                    ...
                    cell.setColspan(2);
                    table.addCell(cell);
                    cell = new PdfPCell(new Paragraph(StringEscapeUtils.unescapeHtml(p.getProperty("label.custoditapresso"))+stringaObbligatorio, normalFont));
                    cell.setColspan(2);
                    cell.setGrayFill(0.90f);
                    table.addCell(cell);
                    ...
                    //if(dataForm.getAnagrafica().getDatiProfessionistaBean().getAgiscePerContoDi().equalsIgnoreCase("PF")){
                        cell = new PdfPCell(new Paragraph(StringEscapeUtils.unescapeHtml(p.getProperty("pdfBlank.titolarePF")), boldFont));
                        cell.setColspan(8);
                        table.addCell(cell);
                    
                        cell = new PdfPCell(new Paragraph(StringEscapeUtils.unescapeHtml(p.getProperty("label.nomecognome"))+stringaObbligatorio, normalFont));
                        cell.setColspan(4);
                        cell.setGrayFill(0.90f);
                        table.addCell(cell);
                    ...
                    //else if(dataForm.getAnagrafica().getDatiProfessionistaBean().getAgiscePerContoDi().equalsIgnoreCase("PG")){
                        cell = new PdfPCell(new Paragraph(StringEscapeUtils.unescapeHtml(p.getProperty("pdfBlank.titolarePG")), boldFont));
                        cell.setColspan(8);
                        table.addCell(cell);
                    
                        cell = new PdfPCell(new Paragraph(StringEscapeUtils.unescapeHtml(p.getProperty("label.anagrafica.denominazione"))+stringaObbligatorio, normalFont));
                        cell.setColspan(4);
                        cell.setGrayFill(0.90f);
                        table.addCell(cell);
...
//                float[] widths = {20f, 27f, 13f, 27f, 13f};
    ...
    //            table.addCell(cell);
            ...
            while(itKey.hasNext()){
                ...
                Object[][] datiHref = HtmlRenderer.getDatiHrefPdfBlanc(sezComp);
                    ...
                    for(int i=0; i<datiHref.length; i++){
                        ...
                        for(int n=0; n<riga.length; n++){
                            if(riga[n] != null){
                                ...
                                if(cella[2].equalsIgnoreCase("I") || cella[2].equalsIgnoreCase("T") || cella[3] != null){
...
//                                        cellaConInnerTable.cloneNonPositionParameters(getBordoInvisibile());
                                ...
                                else if(cella[2].equalsIgnoreCase("L") || cella[3] != null){
                                    PdfPTable innerTable = new PdfPTable(cella[3] == null ? 2 : 1);
                                    ...
                                    pdcell = new PdfPCell(new Paragraph(cella[1]==null||cella[1].equalsIgnoreCase("")?cella[4]:cella[4]/*cella[1]*/, boldFont));
                                    if(n!=ultimaColonnaPiena)
                                        pdcell.cloneNonPositionParameters(getBordoInvisibile());
                                    innerTable.addCell(pdcell);
...
//                                        cellaConInnerTable.cloneNonPositionParameters(getBordoInvisibile());
                                    ...
                                    if(cella[1] != null && !cella[1].equalsIgnoreCase("")){
                                        pdcell = new PdfPCell(jpg/*jpgFlg*/);
                                    }
                                    else{
...
//            String path = "C:\\Program Files\\Adobe\\Acrobat 7.0\\Reader\\AcroRd32.exe";
    ...
    private String convertiLista(LinkedList lista, boolean aCapoPrimaRiga){
        String retVal = "";
        if(aCapoPrimaRiga)
            retVal = "\n";
        ...
        while(it.hasNext()){
            ...
            if(bb != null && bb.getDescrizione() != null)
                if(!bb.getCodice().equalsIgnoreCase("ALTRO"))
                    retVal += "[  ] "+bb.getDescrizione()+"\n";
                else
                    retVal += "[  ] "+bb.getDescrizione()+" __________________\n";
        }
        return retVal;
    }
    
    private String convertiLista(LinkedList lista){
        return convertiLista(lista, false);
    }
    
    public static HashMap getContenutocomboRappresentanze(HttpSession session) throws IOException, ServletException{
        ...
        int i=1;
        java.util.List listaCombo = new LinkedList();
        // Combo Impresa
        while(continua){
        ...
        i=1;
        continua = true;
        java.util.List listaCombo2 = new LinkedList();
        // Combo Privato
        while(continua){
        ...
        i=1;
        continua = true;
        java.util.List listaCombo3 = new LinkedList();
        // Combo AltroEnte
        while(continua){
        ...
        i=1;
        continua = true;
        java.util.List listaCombo4 = new LinkedList();
        // Combo AltroEnte
        while(continua){
        ...
        i=1;
        continua = true;
        java.util.List listaCombo5 = new LinkedList();
        // Combo AltroEnte
        while(continua){
        ...
        i=1;
        continua = true;
        java.util.List listaCombo6 = new LinkedList();
        // Combo AltroEnte
        while(continua){
        ...
        i=1;
        continua = true;
        java.util.List listaCombo7 = new LinkedList();
        // Combo AltroEnte
        while(continua){
    ...
    private static String[] splitCodiceEDescrizioneCombo(String codice){
